...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_multiply_v2_1 is
  port (
    \read_data_out_reg[2]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_multiply_v2_1 : entity is "matrix_multiply_v2";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_multiply_v2_1;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_multiply_v2_1 is
...
B_RAM: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memory_RAM__parameterized0\
     port map (
      ACLK => ACLK,
      DI(5) => B_RAM_n_0,
      DI(4) => B_RAM_n_1,
...
C_RAM: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memory_RAM__parameterized0_0\
     port map (
      ACLK => ACLK,
      DI(4) => C_RAM_n_0,
      DI(3) => C_RAM_n_1,
...
matrix_multiply_A_C: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_multiply_v2_1
     port map (
      ACLK => ACLK,
      ADDRBWRADDR(7 downto 0) => sel(7 downto 0),
